...
def assign_default_permissions():
    ...
    registered_perms = ['react_forum_posts']
    ...
    web.models.Role.objects.get(slug='registered').permissions.set(Permission.objects.filter(codename__in=registered_perms, content_type=content_type))
