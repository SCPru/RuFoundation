# Generated by Django 4.0.6 on 2022-08-23 19:47
...
def replacer(match):
    ...
    if 'rimg' not in cls.split(' ') and 'cimg' not in cls.split(' ') and 'limg' not in cls.split(' ') and 'img' not in cls.split(' '):
        return match[0]
