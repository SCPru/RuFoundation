                ...
                <div className="w-upload-files">
                    ...
                    {uploadFiles.length ?
                        <div className="w-upload-rows">
                                ...
                                return (
                                    <div key={i} className="w-upload-row">
                                        <div className="w-upload-info">
                                            ...
                                            {(!file.uploading)?<a href="#" className="w-upload-btn" onClick={e=>this.onUploadFile(e, file)}>Загрузить</a>:null}
                                        </div>
                                        {(file.uploading)?
                                            <>
                            ...
                            <a href="#" className="w-upload-btn w-upload-all" onClick={this.onUploadAll}>Загрузить все</a>
                        </div>
                        : null}
                </div>
            </>
    ...
    render() {
        ...
        return (
            <Styles>
                ...
                { (renameIndex != null) && (
                    <WikidotModal buttons={[{title: 'Переименовать', onClick: this.onRename}, {title: 'Отмена', onClick: this.onCancelRename}]}>
                        <h1>Переименовать</h1>
                                ...
                                {files.map((file, i) => {
                                    return (
                                        <React.Fragment key={i}>
                                            ...
                                            {(optionsIndex===i)?<tr className="highlight">
                                                <td/>
                                                <td/>
                                                <td/>
                                                <td colSpan={4} className="options">
                                                    <a className="btn btn-primary btn-sm btn-small" href="#" onClick={e=>this.onOptionsRename(e, i)}>Переименовать</a>
                                                    &nbsp;
                                                    <a className="btn btn-primary btn-sm btn-small" href="#" onClick={e=>this.onOptionsDelete(e, i)}>Удалить</a>
                                                </td>
                                            </tr>:null}
                                        </React.Fragment>
                                    )
