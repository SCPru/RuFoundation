...
const ArticleTags: React.FC<Props> = ({ pageId, isNew, onClose, canCreateTags }) => {
  ...
  return (
    <Styles>
      ...
      <h1>Теги страницы</h1>
      <p>
        Теги (метки) это хороший способ для организации содержимого на сайте, для создания "горизонтальной навигации" между связанными по смыслу
        страницами. Вы можете добавить несколько тегов к каждой из ваших страниц. Читайте подробнее про{' '}
        <a href="http://ru.wikipedia.org/wiki/%D0%A2%D0%B5%D0%B3" target="_blank">
          {' '}
          теги
        </a>
        , про{' '}
        <a href="http://ru.wikipedia.org/wiki/%D0%9E%D0%B1%D0%BB%D0%B0%D0%BA%D0%BE_%D1%82%D0%B5%D0%B3%D0%BE%D0%B2" target="_blank">
          облако тегов{' '}
        </a>
      </p>
