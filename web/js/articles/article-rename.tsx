            ...
            <form method="POST" onSubmit={onSubmit}>
                <table className="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="newName" className={`text ${loading?'loading':''}`} onChange={onChange} id="page-rename-input" defaultValue={newName} disabled={loading||saving} autoFocus/>
                        </td>
                    </tr>
                    </tbody>
                </table>
