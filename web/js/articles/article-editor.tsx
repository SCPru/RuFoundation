            ...
            <form id="edit-page-form" onSubmit={onSubmit}>
                <table className="form" style={{ margin: '0.5em auto 1em 0' }}>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="edit-page-title" value={title} onChange={onChange} name="title" type="text" size={35} maxLength={128} style={{ fontWeight: 'bold', fontSize: '130%' }} disabled={loading||saving} />
                        </td>
                    </tr>
                    </tbody>
                </table>
                ...
                <div className={`editor-area ${loading?'loading':''}`}>
                    <textarea id="edit-page-textarea" value={source} onChange={onChange} name="source" rows={20} cols={60} style={{ width: '95%' }} disabled={loading||saving} />
                    <p>Краткое описание изменений:</p>
                    <textarea id="edit-page-comments" value={comment} onChange={onChange} name="comment" rows={3} cols={20} style={{ width: '35%' }} disabled={loading||saving} />
                ...
                <div className="buttons alignleft">
                    ...
                    <input id="edit-save-button" className="btn btn-primary" type="button" name="save" value="Сохранить" onClick={onSubmit} disabled={loading||saving} />
                </div>
            </form>
        </Styles>
    )
