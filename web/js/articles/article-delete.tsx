...
const ArticleDelete: React.FC<Props> = ({ pageId, onClose, canDelete }) => {
    ...
    return (
        <Styles>
            { saving && <WikidotModal isLoading><p>Удаление...</p></WikidotModal> }
            { savingSuccess && <WikidotModal><p>Успешно удалено!</p></WikidotModal> }
            { error && (
            ...
            {canDelete&&<table className="form">
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="permanent" className={`text ${loading?'loading':''}`} onChange={onChange} id="page-rename-input" checked={!permanent} disabled={loading||saving||!canDelete}/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="permanent" className={`text ${loading?'loading':''}`} onChange={onChange} id="page-permanent-input" checked={permanent} disabled={loading||saving}/>
