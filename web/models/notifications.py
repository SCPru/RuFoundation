...
class UserNotification(auto_prefetch.Model):
    ...
    class NotificationType(models.TextChoices):
        ...
        ForumMention = ('forum_mention', 'Упоминание на форуме')

    type = models.TextField('Тип уведомления', choices=NotificationType.choices, blank=False, null=False)
    meta = models.JSONField('Мета', default=dict, blank=True, null=False)
    created_at = models.DateTimeField('Дата отправки', auto_now_add=True, blank=False, null=False)
